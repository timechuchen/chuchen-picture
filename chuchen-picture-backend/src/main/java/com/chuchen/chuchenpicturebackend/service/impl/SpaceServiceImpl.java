...
import com.chuchen.chuchenpicturebackend.model.enums.SpaceLevelEnum;
import com.chuchen.chuchenpicturebackend.model.enums.SpaceRoleEnum;
...
import com.chuchen.chuchenpicturebackend.mapper.SpaceMapper;
import com.chuchen.chuchenpicturebackend.service.SpaceUserService;
    ...
    public long addSpace(SpaceAddRequest spaceAddRequest, User loginUser) {
        ...
        synchronized (lock) {
            Long newSpaceId = transactionTemplate.execute(status -> {
                ...
                ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "保存空间数据库失败");
                // 如果是团队空间，关联新增团队成员记录
